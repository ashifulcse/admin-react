                    ...
                    <nav className="navbar navbar-light navbar-vertical navbar-expand-xl" >
                        ...
                        <div className="d-flex align-items-center">
                            <div className="toggle-icon-wrapper">
                                ...
                                <div className="d-flex align-items-center py-3"><img className="me-2" src="assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span className="font-sans-serif">falcon</span></div>
                            </a>
                        </div>
